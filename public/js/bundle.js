...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaWFtcHJpbmNlc2x5IiwiYSI6ImNrdG93eDUxaTBoMWYyb3BuNW8zMXF2YnEifQ.QQDI6VVCD0_dfETn2FnyYw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/iamprincesly/cktox22t71ohy18n6sjxru4ov',
    scrollZoom: false // center: [-117.48706580201055, 34.74319862831102],
    // zoom: 1,
    // interactive: false,
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Login in successfully!');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:3000/api/v1/users/update-password' : 'http://127.0.0.1:3000/api/v1/users/update-info';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_51JcCAXBApHaANlgHunWbL2N9HjhyKW6G8GwdHJ1nTfX0IZpRkMZAySJ4wAGvxs9vHgckaH8Fj2Fxz3kRvdlmxXBd008EYDxKMR');
